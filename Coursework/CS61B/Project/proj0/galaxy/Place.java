...
class Place {
    ...
    /** Instantiate instance variable _isBoundary. */
    private boolean _isBoundary = false;

    /** Instantiate method getBoundary.
     * @return boolean
     */
    public boolean getBoundary() {
        return this._isBoundary;
    }
    /** Instantiate instance method setBoundary.
     * @param val val
     */
    public void setBoundary(boolean val) {
        this._isBoundary = val;
    }
