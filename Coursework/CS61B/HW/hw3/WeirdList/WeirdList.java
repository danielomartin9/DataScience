...
public class WeirdList {
    public int head_;
    public WeirdList tail_;

    /** The empty sequence of integers. */
    public static final WeirdList EMPTY = ; // REPLACE THIS LINE WITH THE RIGHT ANSWER.
    ...
    public WeirdList map(IntUnaryFunction func) {
        return new WeirdList(func.apply(head_), tail_.map(func));
    }
