...
class MissManners:
    ...
    def ask(self, message, *args):
        ...
        "*** YOUR CODE HERE ***"
        # if message.endswith('deposit'):
        # 	if hasattr(self.obj, 'deposit'):
        # 		return getattr(self.obj, 'deposit')(*args)
        # elif message.endswith('vend'):
        # 	if hasattr(self.obj, 'vend'):
        # 		return getattr(self.obj, 'vend')(*args)
        # elif message.endswith('restock'):
        # 	if hasattr(self.obj, 'restock'):
        # 		return getattr(self.obj, 'restock')(*args)
        # elif not hasattr(self.obj, message[7:]):
