    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                assert self.ant is None or self.ant == insect or self.ant.ant == insect, 'Two ants in {0}'.format(self)
                # END Problem 9
        else:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                if hasattr(self.ant, 'imposter') and self.ant.imposter == False:
                    return None
                ...
                if hasattr(self.ant, 'container') and self.ant.container and self.ant.ant is insect:
                    if hasattr(self.ant.ant, 'imposter') and self.ant.ant.imposter == False:
                        return None
                    else:
                        self.ant.ant = None 
                else:
...
class Bee(Insect):
    ...
    name = 'Bee'
    damage = 1
    watersafe = True #because bees can fly
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        while loc != None and self.imposter == False:
            if loc.ant != None:
                if loc.ant not in self.ants_behind:
                    self.ants_behind.append(loc.ant)
                    loc.ant.damage *= 2
                if loc.ant.container:
                    if loc.ant.ant != None:
                        if loc.ant.ant not in self.ants_behind:
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        remaining_armor = self.armor - amount
        if self.imposter == False and remaining_armor <= 0:
            bees_win()
        # END Problem 13
