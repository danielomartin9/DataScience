...
(define (add_two x) (+ x 2))(add_two 4)
; expect 6

(define (double x) (* x 2))(double 4)
; expect 8

(define double (lambda (x)(* x 2)))(double 4)
; expect 8
...
(define (test x)(if (= x 0) (quote zero) (quote not zero)))
; expect test
...
(let ((x (lambda (a)(* 2 a))) (y 3)) (x y))
; expect 6

(define a 'hello)
(define b 'world)

(let ((a 'good)(b 'bye)) (list a b))
; expect (good bye)
