...
def scheme_eval(expr, env, _=None): # Optional third argument is ignored
    ...
    if scheme_symbolp(first) and first in SPECIAL_FORMS:
        ...
        # BEGIN PROBLEM 5
        "*** YOUR CODE HERE ***"
        operator = scheme_eval(first, env, _=None)
        operands = rest.map(lambda y: scheme_eval(y, env, _=None))
...
def eval_all(expressions, env):
    ...
    if expressions is nil:
    	...
    	while expressions.second is not nil:
    		scheme_eval(expressions.first, env, _=None)
...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        child = Frame(self) # Create a new child with self as the parent
       	# print(vals)
       	# print(formals)
       	# print(formals.first is nil)
        # BEGIN PROBLEM 11
        "*** YOUR CODE HERE ***"
        if len(vals) != len(formals):
        	raise SchemeError('number of argument values does not match number of formal parameters')
...
class PrimitiveProcedure(Procedure):
    ...
    def apply(self, args, env):
        ...
        try:
            ...
            raise SchemeError('Arguments not applicable to function')
        # END PROBLEM 4
...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(target):
        ...
        # BEGIN PROBLEM 6
        "*** YOUR CODE HERE ***"
        env.define(target, scheme_eval(expressions.second.first, env, _=None))
        return target
        # END PROBLEM 6
    elif isinstance(target, Pair) and scheme_symbolp(target.first):
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        # print(target.first) # symbol
        # print(target.second) #formal parameters
        # print(expressions.first) # symbol + parameters
        # print(expressions.second) # procedure body
...
def do_lambda_form(expressions, env):
    ...
    check_form(expressions, 2)
    formals = expressions.first #formal parameters
    check_formals(formals) 
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    procedure_body = expressions.second
    #print(expressions)
    # print(formals)
    # print(expressions.second)
    # print(env)
    if procedure_body is nil:
    	raise SchemeError('must be at least one expression in the body of the procedure')
    return LambdaProcedure(formals, procedure_body, env)
    # END PROBLEM 9
...
def do_and_form(expressions, env):
    ...
    #print('expressions 1:', expressions.first)
    #print('expressions 2:', expressions.second.first)
    while expressions.second is not nil:
...
def do_mu_form(expressions, env):
    ...
    if procedure_body is nil:
        raise SchemeError('must be at least one expression in the body of the procedure')
    return MuProcedure(formals, procedure_body)
    # END PROBLEM 16
